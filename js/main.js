...
module.exports = {
    ...
    closeMainMenuSubmenu: function closeMainMenuSubmenu(mainMenuItem) {
    ...
    openMainMenuSubmenu: function openMainMenuSubmenu(mainMenuItem) {
        var mainMenuSubmenuContainer = mainMenuItem.find('.pageHeader__mainMenuSubmenuContainer'),
    ...
    closeMainMenuSubmenuItem: function closeMainMenuSubmenuItem(mainMenuSubmenuItem) {
    ...
    openMainMenuSubmenuItem: function openMainMenuSubmenuItem(mainMenuSubmenuItem) {
        var mainMenuSubmenu = mainMenuSubmenuItem.find('.pageHeader__mainMenuSubSubmenu'),
            mainMenuSubmenuLinkHeight = mainMenuSubmenu.find('.pageHeader__mainMenuSubSubmenuLink').height();
        mainMenuSubmenuItem.addClass('pageHeader__mainMenuSubmenuItem_opened');
        setTimeout(function () {
    ...
    closeAllMenuItems: function closeAllMenuItems(mainMenu) {
        var self = this;
...
},{"../../scripts/modules/config.js":6,"jquery":4}],3:[function(require,module,exports){
'use strict';
